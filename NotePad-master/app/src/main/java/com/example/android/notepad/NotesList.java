...
import static com.example.android.notepad.NotePad.Notes.COLUMN_NAME_CREATE_DATE;
...
//        getListView().setOnCreateContextMenuListener(this);
        ...
        notesAdapter.setList(notesEntityArrayList);
...
//        setListAdapter(adapter);
    ...
    private void onLoad(String title){
        ...
        notesEntityArrayList.clear();
        while (cursor.moveToNext()) {
            NotesEntity entity = new NotesEntity();
            entity.setId(cursor.getInt(cursor.getColumnIndex(NotePad.Notes._ID)));
            entity.setTitle(cursor.getString(cursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_TITLE)));
            entity.setCreated(cursor.getString(cursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_CREATE_DATE)));
            notesEntityArrayList.add(entity);
        }
        if (!TextUtils.isEmpty(title)){
            for (int i=notesEntityArrayList.size()-1;i>=0;i--){
                if (!notesEntityArrayList.get(i).getTitle().contains(title)){
    ...
    private ArrayList<NotesEntity> notesEntityArrayList = new ArrayList<>();
...
//        final boolean haveItems = notesAdapter.getCount() > 0;
//
...
//                return true;
    ...
    public void onCreateContextMenu(ContextMenu menu, View view, ContextMenuInfo menuInfo) {
         ...
         */
        Cursor cursor = (Cursor) notesAdapter.getItem(info.position);
...
//    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Uri uri = ContentUris.withAppendedId(getIntent().getData(), notesEntityArrayList.get(position).getId());
        Log.e("下标=",position+"==="+id+"==="+uri+"==="+notesEntityArrayList.get(position).getId());
