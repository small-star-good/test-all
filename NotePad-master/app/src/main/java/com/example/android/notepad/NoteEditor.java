...
//                setTitle(getText(R.string.title_create));
                edit_title.setText(getText(R.string.title_create));
            }
...
//            setTitle(getText(R.string.error_title));
            edit_title.setText(getText(R.string.error_title));
            edit_content.setText(getText(R.string.error_message));
        }
    }
...
//        }
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        String currentNote = edit_content.getText().toString();
...
//END_INCLUDE(paste)
    ...
    private final void updateNote(String text, String title) {
        ...
        values.put(NotePad.Notes.COLUMN_NAME_CREATE_DATE, str);
